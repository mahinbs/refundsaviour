...
export function Header({ title, onMenuClick }) {
    ...
    return (
        <header className="sticky top-0 z-30 flex h-20 items-center justify-between border-b border-white/5 bg-background/50 px-4 md:px-8 backdrop-blur-xl">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="hidden md:block text-xs text-muted-foreground">Overview & Statistics</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-6">
                ...
                <button
                    ...
                    className="relative rounded-full bg-white/5 p-2 text-muted-foreground hover:bg-white/10 hover:text-white transition-colors"
                >
                ...
                <div
                    ...
                    className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 pl-2 pr-4 py-1.5 hover:bg-white/10 cursor-pointer transition-colors"
                >
